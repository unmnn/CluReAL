...
'CluReAL.v2', which is designed improve an existing clustering solution by 
...
object from step 1. The output is a list with the following elements:
  ...
  * `oi_st`: cluster-individual strict overlap indices (double vector of length 
  k)
  * `oi_rx`: cluster-individual relaxed overlap indices (double vector of length
  k)
